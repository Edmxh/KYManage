...
public class WXExceptionAdapter extends ArrayAdapter<GetPurchaseOrderInfoJSRep>implements View.OnClickListener {
    ...
    public WXExceptionAdapter(Context context, int textViewResourceId, List<GetPurchaseOrderInfoJSRep> objects){
...
//        });
        ...
        viewHolder.xsddh_hang.setText(rep.getMarketorderno()+"/"+rep.getMarketorderrow());
...
//        }
        ...
        //下拉框
        adapter2 = new ArrayAdapter<String>(getContext(), R.layout.defined_spinner_item, exceptionList);
        //设置下拉列表的风格
