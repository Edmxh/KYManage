...
public class Print3Record1Adapter extends ArrayAdapter<GetDeliveryListDataJSRepBean>implements View.OnClickListener {
    private int resourceId;
    private InnerItemOnclickListener mListener;
    HashMap<Integer, Boolean> select=new HashMap<>();
    private List<GetDeliveryListDataJSRepBean> mList;
    //private DataBean1 DataBean1;

    // 适配器的构造函数，把要适配的数据传入这里
    public Print3Record1Adapter(Context context, int textViewResourceId, List<GetDeliveryListDataJSRepBean> objects){
        super(context,textViewResourceId,objects);
        resourceId=textViewResourceId;
        mList=objects==null?new ArrayList<GetDeliveryListDataJSRepBean>():objects;
        initData();
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
        final GetDeliveryListDataJSRepBean rep=getItem(position); //获取当前项的DataBean1实例
        ...
        viewHolder.fhdh=view.findViewById(R.id.fhdh);
        ...
        viewHolder.fhr=view.findViewById(R.id.fhr);
...
//        });
        ...
        viewHolder.fhdh.setText(rep.getDeliveryListNO());
        viewHolder.psdx.setText(rep.getClientName());
