...
public class KFPSDAdapter extends ArrayAdapter<DemoBean1> {
    private int resourceId;

    //private DataBean1 DataBean1;

    // 适配器的构造函数，把要适配的数据传入这里
    public KFPSDAdapter(Context context, int textViewResourceId, List<DemoBean1> objects){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (convertView==null){
            ...
            viewHolder.cd=view.findViewById(R.id.cd);
...
//        });
        ...
        viewHolder.wlms.setText(rep.getStr2());
        viewHolder.gc.setText(rep.getStr3());
        viewHolder.cd.setText(rep.getStr4());
