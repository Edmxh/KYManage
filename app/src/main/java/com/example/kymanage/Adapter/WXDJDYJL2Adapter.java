...
public class WXDJDYJL2Adapter extends ArrayAdapter<DemoBean1> {
    private int resourceId;

    //private DataBean1 DataBean1;

    // 适配器的构造函数，把要适配的数据传入这里
    public WXDJDYJL2Adapter(Context context, int textViewResourceId, List<DemoBean1> objects){
...
//        });
        ...
        viewHolder.sl.setText(rep.getStr2());
