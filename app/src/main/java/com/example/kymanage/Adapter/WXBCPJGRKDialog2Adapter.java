...
public class WXBCPJGRKDialog2Adapter extends ArrayAdapter<PreMaterialProductOrderRep>implements View.OnClickListener {
    ...
    public WXBCPJGRKDialog2Adapter(Context context, int textViewResourceId, List<PreMaterialProductOrderRep> objects){
