...
public class CGDialogTestAdapter extends ArrayAdapter<DemoBean1> {
    private int resourceId;

    //private DataBean1 DataBean1;

    // 适配器的构造函数，把要适配的数据传入这里
    public CGDialogTestAdapter(Context context, int textViewResourceId, List<DemoBean1> objects){
...
//        });
        ...
        viewHolder.xqjb.setText(rep.getStr1());
        viewHolder.scddh.setText(rep.getStr2());
        viewHolder.jhksrq.setText(rep.getStr3());
