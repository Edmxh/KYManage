...
public class CGDialogAdapter extends ArrayAdapter<PreMaterialProductOrderRep> {
    private int resourceId;
    private List<PreMaterialProductOrderRep> mList;
    //private DataBean1 DataBean1;

    // 适配器的构造函数，把要适配的数据传入这里
    public CGDialogAdapter(Context context, int textViewResourceId, List<PreMaterialProductOrderRep> objects){
