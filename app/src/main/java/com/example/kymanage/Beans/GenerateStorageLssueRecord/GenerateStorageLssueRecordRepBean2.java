 ...
 *         }
 */
public class GenerateStorageLssueRecordRepBean2 {
    private String MaterialDesc;
    private String MarketOrderNO;
    private List<GenerateStorageLssueRecordRepBean1> data;
    ...
    public List<GenerateStorageLssueRecordRepBean1> getData() {
        return data;
    }

    public void setData(List<GenerateStorageLssueRecordRepBean1> data) {
        this.data = data;
    }
